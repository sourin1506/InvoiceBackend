package com.invoice.Invoicedata.InvoiceEntity;
...
public class Invoice {
	...
	public Invoice(String business_code, String cust_number, String name_customer, Date clear_date, int business_year,
			long doc_id, Date posting_date, Date document_create_date, Date due_in_date, String invoice_currency,
			String document_type, int posting_id, String area_business, double total_open_amount,
			Date baseline_create_date, String cust_payment_terms, long invoice_id, int isOpen) {
		super();
